...
class NetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post networks_url, params: { network: { code: @network.code, created_at: @network.created_at, created_by: @network.created_by, label: @network.label, license_id: @network.license_id, name: @network.name, updated_at: @network.updated_at } }
    end
  ...
  test "should update network" do
    patch network_url(@network), params: { network: { code: @network.code, created_at: @network.created_at, created_by: @network.created_by, label: @network.label, license_id: @network.license_id, name: @network.name, updated_at: @network.updated_at } }
