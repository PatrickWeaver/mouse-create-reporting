...
class GroupUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_user" do
    assert_difference('GroupUser.count') do
      post group_users_url, params: { group_user: { code: @group_user.code, created_at: @group_user.created_at, group_id: @group_user.group_id, status: @group_user.status, updated_at: @group_user.updated_at, user_id: @group_user.user_id } }
    end
  ...
  test "should update group_user" do
    patch group_user_url(@group_user), params: { group_user: { code: @group_user.code, created_at: @group_user.created_at, group_id: @group_user.group_id, status: @group_user.status, updated_at: @group_user.updated_at, user_id: @group_user.user_id } }
